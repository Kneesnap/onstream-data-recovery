...
{
    /// <summary>
    /// Represents an unsigned 16-bit fixed point decimal number.
    ...
    public struct UFixedPoint16
    {
        private byte _decimalBits;

        /// <summary>
        /// Gets the raw ushort which contains the bits of the fixed point number.
        /// </summary>
        ...
        public UFixedPoint16(float value, int decimalBitCount) {
        ...
        /// <param name="decimalBitCount">The number of decimal bits to use.</param>
        public UFixedPoint16(ushort value, int decimalBitCount) {
            // Set default values.
        ...
        /// </summary>
        public float Value {
            readonly get => NumberUtils.ConvertFixedPointUShortToFloat(this.FixedValue, this._decimalBits);
            set {
                if (!NumberUtils.IsRealNumber(value))
                    throw new ArgumentException($"Cannot represent {value} as a fixed point number.", nameof(value));
                if (value < 0)
                ...
                this.FixedValue = NumberUtils.ConvertFloatToFixedPointUShort(value, this._decimalBits);
            }
        }
        ...
        public readonly bool Equals(UFixedPoint16 other) {
        ...
        public override readonly string ToString() {
            return $"UFixed[{this.NumberOfIntegerBits}.{this.NumberOfDecimalBits}]{{Fixed={this.FixedValue},Float={this.Value}}}";
        }

        /// <inheritdoc cref="ValueType.Equals(object?)"/>
        public override readonly bool Equals(object obj) {
            return obj is UFixedPoint16 other && this.Equals(other);
        }
        ...
        public static implicit operator ushort(UFixedPoint16 num) => num.FixedValue;
        public static implicit operator float(UFixedPoint16 num) => num.Value;
        ...
        /// <returns>sum</returns>
        public static UFixedPoint16 operator +(UFixedPoint16 numOne, UFixedPoint16 numTwo) {
        ...
        /// <returns>sum</returns>
        public static UFixedPoint16 operator +(UFixedPoint16 numOne, float numTwo) {
        ...
        /// <returns>sum</returns>
        public static float operator +(float numOne, UFixedPoint16 numTwo) {
        ...
        /// <param name="numTwo">The right-hand number to add.</param>
        /// <returns>sum</returns>
        public static UFixedPoint16 operator +(UFixedPoint16 numOne, ushort numTwo) {
        ...
        /// <param name="numTwo">The right-hand number to add.</param>
        /// <returns>sum</returns>
        public static ushort operator +(ushort numOne, UFixedPoint16 numTwo) {
            return (ushort)(numOne + numTwo.FixedValue);
        }
        ...
        /// <returns>product</returns>
        public static UFixedPoint16 operator *(UFixedPoint16 fixedNumber, float floatNumber) {
        ...
        /// <param name="fixedNumber">The fixed-point number to multiply.</param>
        /// <returns>product</returns>
        public static float operator *(float floatNumber, UFixedPoint16 fixedNumber) {
        ...
        /// <returns>quotient</returns>
        public static UFixedPoint16 operator /(UFixedPoint16 fixedNumber, float divisor) {
        ...
        /// <returns>quotient</returns>
        public static float operator /(float floatNumber, UFixedPoint16 divisor) {
        ...
        public static bool operator ==(UFixedPoint16 numOne, UFixedPoint16 numTwo) {
        ...
        /// <returns>Are the numeric values equal?</returns>
        public static bool operator ==(UFixedPoint16 fixedNum, float floatNum) {
            return fixedNum.FixedValue == NumberUtils.ConvertFloatToFixedPointUShort(floatNum, fixedNum.NumberOfDecimalBits);
        }
        ...
        /// <param name="numTwo">The second fixed-point number.</param>
        /// <returns>Are the numeric values equal?</returns>
        public static bool operator ==(UFixedPoint16 numOne, ushort numTwo) {
        ...
        public static UFixedPoint16 operator <<(UFixedPoint16 number, int shiftAmount) {
            if (shiftAmount < 0 || shiftAmount > BitCount)
                throw new ArgumentOutOfRangeException(nameof(shiftAmount), $"A {nameof(UFixedPoint16)} cannot be shifted left {shiftAmount} bits. (Must be between 0 and {BitCount}.)");
            number.FixedValue = (ushort)((number.FixedValue << shiftAmount) & 0xFFFF);
            return number;
        }
        ...
        public static UFixedPoint16 operator >>(UFixedPoint16 number, int shiftAmount) {
            if (shiftAmount < 0 || shiftAmount > BitCount)
                throw new ArgumentOutOfRangeException(nameof(shiftAmount), $"A {nameof(UFixedPoint16)} cannot be shifted right {shiftAmount} bits. (Must be between 0 and {BitCount}.)");
            number.FixedValue = (ushort)((number.FixedValue >> shiftAmount) & 0xFFFF);
            return number;
        }
        ...
        public static UFixedPoint16 operator &(UFixedPoint16 number, UFixedPoint16 bitMask) {
        ...
        /// <param name="bitMask">The bit mask to apply.</param>
        /// <returns>result</returns>
        public static UFixedPoint16 operator &(UFixedPoint16 number, ushort bitMask) {
        ...
        /// <param name="bitMask">The bit mask to apply.</param>
        /// <returns>result</returns>
        public static UFixedPoint16 operator &(UFixedPoint16 number, int bitMask) {
            number.FixedValue = (ushort)(number.FixedValue & bitMask);
            return number;
        }
        ...
        /// <param name="number">The number to apply the mask to.</param>
        /// <returns>result</returns>
        public static UFixedPoint16 operator ~(UFixedPoint16 number) {
            number.FixedValue = (ushort)~number.FixedValue;
            return number;
        }
        ...
        public static UFixedPoint16 operator %(UFixedPoint16 number, UFixedPoint16 divisor) {
            if (number._decimalBits == divisor._decimalBits) {
                number.FixedValue %= divisor.FixedValue;
                return number;
            }

            uint fixedValue = unchecked((uint)(number.FixedValue << number._decimalBits));
            uint divisorFixedValue = unchecked((uint)(divisor.FixedValue << divisor._decimalBits));
            number.FixedValue = unchecked((ushort)((fixedValue % divisorFixedValue) >> number._decimalBits));
            return number;
        }
        ...
        /// <param name="divisor">The divisor to use to compute the modulo.</param>
        /// <returns>modulo</returns>
        public static UFixedPoint16 operator %(UFixedPoint16 number, float divisor) {
        ...
        /// <param name="divisor">The divisor to use to compute the modulo.</param>
        /// <returns>modulo</returns>
        public static UFixedPoint16 operator %(UFixedPoint16 number, ushort divisor) {
