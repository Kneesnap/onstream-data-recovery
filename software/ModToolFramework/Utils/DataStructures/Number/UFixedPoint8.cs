...
{
    /// <summary>
    /// Represents an unsigned 8-bit fixed point decimal number.
    ...
    public struct UFixedPoint8
    {
        private byte _decimalBits;

        /// <summary>
        /// Gets the raw byte which contains the bits of the fixed point number.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new <see cref="UFixedPoint8"/> value.
        /// </summary>
        ...
        public UFixedPoint8(float value, int decimalBitCount) {
        ...
        /// <param name="decimalBitCount">The number of decimal bits to use.</param>
        public UFixedPoint8(byte value, int decimalBitCount) {
            // Set default values.
        ...
        /// </summary>
        public float Value {
            readonly get => NumberUtils.ConvertFixedPointByteToFloat(this.FixedValue, this._decimalBits);
            set {
                if (!NumberUtils.IsRealNumber(value))
                    throw new ArgumentException($"Cannot represent {value} as a fixed point number.", nameof(value));
                if (value < 0)
                ...
                this.FixedValue = NumberUtils.ConvertFloatToFixedPointByte(value, this._decimalBits);
            }
        }
        ...
        public readonly bool Equals(UFixedPoint8 other) {
        ...
        public override readonly bool Equals(object obj) {
            return obj is UFixedPoint8 other && this.Equals(other);
        }
        ...
        public static implicit operator byte(UFixedPoint8 num) => num.FixedValue;
        public static implicit operator float(UFixedPoint8 num) => num.Value;
        ...
        /// <returns>sum</returns>
        public static UFixedPoint8 operator +(UFixedPoint8 numOne, UFixedPoint8 numTwo) {
        ...
        /// <returns>sum</returns>
        public static UFixedPoint8 operator +(UFixedPoint8 numOne, float numTwo) {
        ...
        /// <returns>sum</returns>
        public static float operator +(float numOne, UFixedPoint8 numTwo) {
        ...
        /// <param name="numTwo">The right-hand number to add.</param>
        /// <returns>sum</returns>
        public static UFixedPoint8 operator +(UFixedPoint8 numOne, byte numTwo) {
        ...
        /// <param name="numTwo">The right-hand number to add.</param>
        /// <returns>sum</returns>
        public static byte operator +(byte numOne, UFixedPoint8 numTwo) {
            return (byte)(numOne + numTwo.FixedValue);
        }
        ...
        /// <returns>product</returns>
        public static UFixedPoint8 operator *(UFixedPoint8 fixedNumber, float floatNumber) {
        ...
        /// <param name="fixedNumber">The fixed-point number to multiply.</param>
        /// <returns>product</returns>
        public static float operator *(float floatNumber, UFixedPoint8 fixedNumber) {
        ...
        /// <returns>quotient</returns>
        public static UFixedPoint8 operator /(UFixedPoint8 fixedNumber, float divisor) {
        ...
        /// <returns>quotient</returns>
        public static float operator /(float floatNumber, UFixedPoint8 divisor) {
        ...
        public static bool operator ==(UFixedPoint8 numOne, UFixedPoint8 numTwo) {
        ...
        /// <returns>Are the numeric values equal?</returns>
        public static bool operator ==(UFixedPoint8 fixedNum, float floatNum) {
            return fixedNum.FixedValue == NumberUtils.ConvertFloatToFixedPointByte(floatNum, fixedNum.NumberOfDecimalBits);
        }
        ...
        /// <param name="numTwo">The second fixed-point number.</param>
        /// <returns>Are the numeric values equal?</returns>
        public static bool operator ==(UFixedPoint8 numOne, byte numTwo) {
        ...
        public static UFixedPoint8 operator <<(UFixedPoint8 number, int shiftAmount) {
            if (shiftAmount < 0 || shiftAmount > BitCount)
                throw new ArgumentOutOfRangeException(nameof(shiftAmount), $"A {nameof(UFixedPoint8)} cannot be shifted left {shiftAmount} bits. (Must be between 0 and {BitCount}.)");
            number.FixedValue = (byte)((number.FixedValue << shiftAmount) & 0xFF);
            return number;
        }
        ...
        public static UFixedPoint8 operator >>(UFixedPoint8 number, int shiftAmount) {
            if (shiftAmount < 0 || shiftAmount > BitCount)
                throw new ArgumentOutOfRangeException(nameof(shiftAmount), $"A {nameof(UFixedPoint8)} cannot be shifted right {shiftAmount} bits. (Must be between 0 and {BitCount}.)");
            number.FixedValue = (byte)((number.FixedValue >> shiftAmount) & 0xFF);
            return number;
        }
        ...
        public static UFixedPoint8 operator &(UFixedPoint8 number, UFixedPoint8 bitMask) {
        ...
        /// <param name="bitMask">The bit mask to apply.</param>
        /// <returns>result</returns>
        public static UFixedPoint8 operator &(UFixedPoint8 number, byte bitMask) {
        ...
        /// <param name="bitMask">The bit mask to apply.</param>
        /// <returns>result</returns>
        public static UFixedPoint8 operator &(UFixedPoint8 number, int bitMask) {
            number.FixedValue = (byte)(number.FixedValue & bitMask);
            return number;
        }
        ...
        /// <param name="number">The number to apply the mask to.</param>
        /// <returns>result</returns>
        public static UFixedPoint8 operator ~(UFixedPoint8 number) {
            number.FixedValue = (byte)~number.FixedValue;
            return number;
        }
        ...
        public static UFixedPoint8 operator %(UFixedPoint8 number, UFixedPoint8 divisor) {
            ...
            number.FixedValue = unchecked((byte)((fixedValue % divisorFixedValue) >> number._decimalBits));
            return number;
        }
        ...
        /// <param name="divisor">The divisor to use to compute the modulo.</param>
        /// <returns>modulo</returns>
        public static UFixedPoint8 operator %(UFixedPoint8 number, float divisor) {
        ...
        /// <param name="divisor">The divisor to use to compute the modulo.</param>
        /// <returns>modulo</returns>
        public static UFixedPoint8 operator %(UFixedPoint8 number, byte divisor) {
