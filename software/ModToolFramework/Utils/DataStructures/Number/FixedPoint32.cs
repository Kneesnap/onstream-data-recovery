...
namespace ModToolFramework.Utils.DataStructures.Number
{
    ...
    public struct FixedPoint32
    {
        ...
        /// <summary>
        /// Gets the raw int which contains the bits of the fixed point number.
        /// </summary>
        public int FixedValue { get; set; }

        /// <summary>
        /// Accesses the raw uint which contains the bits of the fixed point number.
        /// </summary>
        public uint UnsignedFixedValue {
            get => unchecked((uint)this.FixedValue);
            set => this.FixedValue = unchecked((int)value);
        }
        ...
        /// <summary>
        /// Creates a new <see cref="FixedPoint32"/> value.
        /// </summary>
        ...
        public FixedPoint32(double value, int decimalBitCount) {
        ...
        /// <param name="decimalBitCount">The number of decimal bits to use.</param>
        public FixedPoint32(int value, int decimalBitCount) {
            // Set default values.
        ...
        /// <param name="value">The fixed point value.</param>
        /// <param name="decimalBitCount">The number of decimal bits to use.</param>
        public FixedPoint32(uint value, int decimalBitCount) : this(unchecked((int)value), decimalBitCount) {
        }
        ...
        /// </summary>
        public double Value {
            readonly get => NumberUtils.ConvertFixedPointIntToDouble(this.FixedValue, this._decimalBits);
            set {
                if (!NumberUtils.IsRealNumber(value))
                    throw new ArgumentException($"Cannot represent {value} as a fixed point number.", nameof(value));

                this.FixedValue = NumberUtils.ConvertDoubleToFixedPointInt(value, this._decimalBits);
            }
        }
        ...
        public readonly bool Equals(FixedPoint32 other) {
        ...
        public override readonly string ToString() {
            return $"Fixed[{this.NumberOfIntegerBits}.{this.NumberOfDecimalBits}]{{Fixed={this.FixedValue},Double={this.Value}}}";
        }

        /// <inheritdoc cref="ValueType.Equals(object?)"/>
        public override readonly bool Equals(object obj) {
            return obj is FixedPoint32 other && this.Equals(other);
        }
        ...
        public readonly void GetBits(out uint integerBits, out uint decimalBits) {
            integerBits = (uint)(this.FixedValue >> this.NumberOfDecimalBits);
        ...
        // But this one should probably default to 'int', since this is signed. But, it could be useful to get this as a uint,
        //  so we retain the ability to explicitly cast to it.
        public static explicit operator uint(FixedPoint32 num) => unchecked((uint)num.FixedValue);
        
        // Implicit casts.
        public static implicit operator int(FixedPoint32 num) => num.FixedValue;
        public static implicit operator float(FixedPoint32 num) => (float)num.Value;
        public static implicit operator double(FixedPoint32 num) => num.Value;
        ...
        /// <returns>sum</returns>
        public static FixedPoint32 operator +(FixedPoint32 numOne, FixedPoint32 numTwo) {
        ...
        /// <returns>sum</returns>
        public static FixedPoint32 operator +(FixedPoint32 numOne, double numTwo) {
        ...
        /// <returns>sum</returns>
        public static double operator +(double numOne, FixedPoint32 numTwo) {
        ...
        /// <param name="numTwo">The right-hand number to add.</param>
        /// <returns>sum</returns>
        public static FixedPoint32 operator +(FixedPoint32 numOne, int numTwo) {
        ...
        /// <param name="numTwo">The right-hand number to add.</param>
        /// <returns>sum</returns>
        public static int operator +(int numOne, FixedPoint32 numTwo) {
        ...
        /// <returns>product</returns>
        public static FixedPoint32 operator *(FixedPoint32 fixedNumber, double doubleNumber) {
        ...
        /// <param name="fixedNumber">The fixed-point number to multiply.</param>
        /// <returns>product</returns>
        public static double operator *(double doubleNumber, FixedPoint32 fixedNumber) {
        ...
        /// <returns>quotient</returns>
        public static FixedPoint32 operator /(FixedPoint32 fixedNumber, double divisor) {
        ...
        /// <returns>quotient</returns>
        public static double operator /(double doubleNumber, FixedPoint32 divisor) {
        ...
        public static bool operator ==(FixedPoint32 numOne, FixedPoint32 numTwo) {
        ...
        /// <returns>Are the two numeric values equal?</returns>
        public static bool operator ==(FixedPoint32 fixedNum, double doubleNum) {
            return fixedNum.FixedValue == NumberUtils.ConvertDoubleToFixedPointInt(doubleNum, fixedNum.NumberOfDecimalBits);
        }
        ...
        /// <param name="numTwo">The second fixed-point number.</param>
        /// <returns>Are the two numeric values equal?</returns>
        public static bool operator ==(FixedPoint32 numOne, int numTwo) {
        ...
        public static FixedPoint32 operator <<(FixedPoint32 number, int shiftAmount) {
            if (shiftAmount < 0 || shiftAmount > BitCount)
                throw new ArgumentOutOfRangeException(nameof(shiftAmount), $"A {nameof(FixedPoint32)} cannot be shifted left {shiftAmount} bits. (Must be between 0 and {BitCount}.)");
        ...
        public static FixedPoint32 operator >>(FixedPoint32 number, int shiftAmount) {
            if (shiftAmount < 0 || shiftAmount > BitCount)
                throw new ArgumentOutOfRangeException(nameof(shiftAmount), $"A {nameof(FixedPoint32)} cannot be shifted right {shiftAmount} bits. (Must be between 0 and {BitCount}.)");
            if (shiftAmount > 0) 
                number.FixedValue = (number.FixedValue >> shiftAmount);
            return number;
        }
        ...
        public static FixedPoint32 operator &(FixedPoint32 number, FixedPoint32 bitMask) {
        ...
        /// <param name="bitMask">The bit mask to apply.</param>
        /// <returns>result</returns>
        public static FixedPoint32 operator &(FixedPoint32 number, int bitMask) {
        ...
        /// <param name="number">The number to apply the mask to.</param>
        /// <returns>result</returns>
        public static FixedPoint32 operator ~(FixedPoint32 number) {
        ...
        public static FixedPoint32 operator %(FixedPoint32 number, FixedPoint32 divisor) {
        ...
        /// <param name="divisor">The divisor to use to compute the modulo.</param>
        /// <returns>modulo</returns>
        public static FixedPoint32 operator %(FixedPoint32 number, double divisor) {
        ...
        /// <param name="divisor">The divisor to use to compute the modulo.</param>
        /// <returns>modulo</returns>
        public static FixedPoint32 operator %(FixedPoint32 number, int divisor) {
