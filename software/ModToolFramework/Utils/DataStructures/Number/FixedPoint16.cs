...
{
    /// <summary>
    /// Represents a signed 16-bit fixed point decimal number.
    ...
    public struct FixedPoint16
    {
        ...
        /// <summary>
        /// Gets the raw short which contains the bits of the fixed point number.
        /// </summary>
        public short FixedValue { get; set; }

        /// <summary>
        /// Accesses the raw ushort which contains the bits of the fixed point number.
        /// </summary>
        public ushort UnsignedFixedValue {
            get => unchecked((ushort)this.FixedValue);
            set => this.FixedValue = unchecked((short)value);
        }
        ...
        /// <summary>
        /// Creates a new <see cref="FixedPoint16"/> value.
        /// </summary>
        ...
        public FixedPoint16(float value, int decimalBitCount) {
        ...
        /// <param name="decimalBitCount">The number of decimal bits to use.</param>
        public FixedPoint16(short value, int decimalBitCount) {
            // Set default values.
        ...
        /// <param name="value">The fixed point value.</param>
        /// <param name="decimalBitCount">The number of decimal bits to use.</param>
        public FixedPoint16(ushort value, int decimalBitCount) : this(unchecked((short)value), decimalBitCount) {
        }
        ...
        /// </summary>
        public float Value {
            readonly get => NumberUtils.ConvertFixedPointShortToFloat(this.FixedValue, this._decimalBits);
            set {
                if (!NumberUtils.IsRealNumber(value))
                    throw new ArgumentException($"Cannot represent {value} as a fixed point number.", nameof(value));

                this.FixedValue = NumberUtils.ConvertFloatToFixedPointShort(value, this._decimalBits);
            }
        }
        ...
        public readonly bool Equals(FixedPoint16 other) {
            if (other._decimalBits == this._decimalBits)
                return this.FixedValue == other.FixedValue;

            this.GetBits(out ushort integerBits, out ushort decimalBits);
            other.GetBits(out ushort otherIntegerBits, out ushort otherDecimalBits);
        ...
        public override readonly bool Equals(object obj) {
            return obj is FixedPoint16 other && this.Equals(other);
        }
        ...
        public readonly void GetBits(out ushort integerBits, out ushort decimalBits) {
            integerBits = (ushort)(this.FixedValue >> this.NumberOfDecimalBits);
            decimalBits = (ushort)(this.FixedValue & ((1 << this.NumberOfDecimalBits) - 1));
        }
        
        // This cast is explicit since it can create type-confusion when used in ambiguous circumstances.
        // But this one should probably default to 'short', since this is signed. But, it could be useful to get this as a ushort,
        //  so we retain the ability to explicitly cast to it.
        public static explicit operator ushort(FixedPoint16 num) => unchecked((ushort)num.FixedValue);
        
        // Implicit casts.
        public static implicit operator short(FixedPoint16 num) => num.FixedValue;
        public static implicit operator float(FixedPoint16 num) => num.Value;
        ...
        /// <returns>sum</returns>
        public static FixedPoint16 operator +(FixedPoint16 numOne, FixedPoint16 numTwo) {
        ...
        /// <returns>sum</returns>
        public static FixedPoint16 operator +(FixedPoint16 numOne, float numTwo) {
        ...
        /// <returns>sum</returns>
        public static float operator +(float numOne, FixedPoint16 numTwo) {
        ...
        /// <param name="numTwo">The right-hand number to add.</param>
        /// <returns>sum</returns>
        public static FixedPoint16 operator +(FixedPoint16 numOne, short numTwo) {
        ...
        /// <param name="numTwo">The right-hand number to add.</param>
        /// <returns>sum</returns>
        public static short operator +(short numOne, FixedPoint16 numTwo) {
            return (short)(numOne + numTwo.FixedValue);
        }
        ...
        /// <returns>product</returns>
        public static FixedPoint16 operator *(FixedPoint16 fixedNumber, float floatNumber) {
        ...
        /// <param name="fixedNumber">The fixed-point number to multiply.</param>
        /// <returns>product</returns>
        public static float operator *(float floatNumber, FixedPoint16 fixedNumber) {
        ...
        /// <returns>quotient</returns>
        public static FixedPoint16 operator /(FixedPoint16 fixedNumber, float divisor) {
        ...
        /// <returns>quotient</returns>
        public static float operator /(float floatNumber, FixedPoint16 divisor) {
        ...
        public static bool operator ==(FixedPoint16 numOne, FixedPoint16 numTwo) {
        ...
        /// <returns>Are the two numeric values equal?</returns>
        public static bool operator ==(FixedPoint16 fixedNum, float floatNum) {
            return fixedNum.FixedValue == NumberUtils.ConvertFloatToFixedPointShort(floatNum, fixedNum.NumberOfDecimalBits);
        }
        ...
        /// <param name="numTwo">The second fixed-point number.</param>
        /// <returns>Are the two numeric values equal?</returns>
        public static bool operator ==(FixedPoint16 numOne, short numTwo) {
        ...
        public static bool operator >(FixedPoint16 numOne, FixedPoint16 numTwo) {
            ...
            numOne.GetBits(out ushort oneIntegerBits, out ushort oneDecimalBits);
            numTwo.GetBits(out ushort twoIntegerBits, out ushort twoDecimalBits);
        ...
        public static FixedPoint16 operator <<(FixedPoint16 number, int shiftAmount) {
            if (shiftAmount < 0 || shiftAmount > BitCount)
                throw new ArgumentOutOfRangeException(nameof(shiftAmount), $"A {nameof(FixedPoint16)} cannot be shifted left {shiftAmount} bits. (Must be between 0 and {BitCount}.)");

            if (shiftAmount > 0)
                number.FixedValue = (short)((number.FixedValue << shiftAmount) & 0xFFFF);
            return number;
        }
        ...
        public static FixedPoint16 operator >>(FixedPoint16 number, int shiftAmount) {
            if (shiftAmount < 0 || shiftAmount > BitCount)
                throw new ArgumentOutOfRangeException(nameof(shiftAmount), $"A {nameof(FixedPoint16)} cannot be shifted right {shiftAmount} bits. (Must be between 0 and {BitCount}.)");
            if (shiftAmount > 0) 
                number.FixedValue = (short)((number.FixedValue >> shiftAmount) & 0xFFFF);
            return number;
        }
        ...
        public static FixedPoint16 operator &(FixedPoint16 number, FixedPoint16 bitMask) {
        ...
        /// <param name="bitMask">The bit mask to apply.</param>
        /// <returns>result</returns>
        public static FixedPoint16 operator &(FixedPoint16 number, short bitMask) {
        ...
        /// <param name="bitMask">The bit mask to apply.</param>
        /// <returns>result</returns>
        public static FixedPoint16 operator &(FixedPoint16 number, int bitMask) {
            number.FixedValue = (short)(number.FixedValue & bitMask);
            return number;
        }
        ...
        /// <param name="number">The number to apply the mask to.</param>
        /// <returns>result</returns>
        public static FixedPoint16 operator ~(FixedPoint16 number) {
            number.FixedValue = (short)~number.FixedValue;
            return number;
        }
        ...
        public static FixedPoint16 operator %(FixedPoint16 number, FixedPoint16 divisor) {
            ...
            number.FixedValue = unchecked((short)((fixedValue % divisorFixedValue) >> number._decimalBits));
            return number;
        }
        ...
        /// <param name="divisor">The divisor to use to compute the modulo.</param>
        /// <returns>modulo</returns>
        public static FixedPoint16 operator %(FixedPoint16 number, float divisor) {
        ...
        /// <param name="divisor">The divisor to use to compute the modulo.</param>
        /// <returns>modulo</returns>
        public static FixedPoint16 operator %(FixedPoint16 number, short divisor) {
